...
uint256 hashGenesisBlock("0x0259826692d5ecf96e50e7bd3ae2bd440ad872530d01b845b001622fec6d6deb");
...
const string strMessageMagic = "EagleCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // EagleCoin: 3 days
static const int64 nTargetSpacing = 180; // EagleCoin: 3 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal eaglecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EagleCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5da98103c9ab6818d2d899604bb60b3352929d8f48ff077095205f92d162159c");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2013-06-28";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1372426238; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2251006;

        if (fTestNet)
        {
            block.nTime    = 1372417712;
            block.nNonce   = 766361;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf9b65225f44effbf8da2ede2cb8a9acbbedaf2ed98139570edbece18146ee301"));
